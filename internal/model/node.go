...
type Stats struct {
	...
	NetworkReceiveMbps  float64   `json:"networkReceiveMbps"`
	NetworkTransmitMbps float64   `json:"networkTransmitMbps"`
	Uptime              uint64    `json:"uptimeSeconds"`
	Timestamp           time.Time `json:"timestamp"`
}

// Disk is one real, physical-ish filesystem or an unmounted external block
// device. Pseudo filesystems like proc/tmpfs/overlay are filtered out.
type Disk struct {
